	...
	<xsl:template name="confirmation">
		<html>
			...
			<body>
				...
				<p class="clearfix">
				Es wird hiermit bestätigt, dass die Dateien der Dissertation des oben genannten Antragstellers bei der Niedersächsischen Staats- und Universitätsbibliothek Göttingen in elektronischer Form abgegeben wurden. Die Arbeit wird nach der bestandenen mündlichen Prüfung veröffentlicht.
