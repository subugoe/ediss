	...
	<xsl:template name="confirmation">
		<html>
			...
			<body>
				...
				<p class="clearfix">
				Es wird hiermit bestätigt, dass die Dissertation des oben genannten Antragstellers von der Niedersächsischen Staats- und Universitätsbibliothek in elektronischer und gedruckter Form entgegengenommen wurde und zu einem späteren Zeitpunkt online gestellt wird.
