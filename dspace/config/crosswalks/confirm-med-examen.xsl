	...
	<xsl:template name="confirmation">
		<html>
			...
			<body>
				...
				Es wird hiermit bestätigt, dass die Dateien der Dissertation des oben genannten Antragstellers bei der Niedersächsischen Staats- und Universitätsbibliothek Göttingen in elektronischer Form abgegeben wurden.
				Die Online-Publikation der Arbeit durch die SUB wird erst erfolgen, wenn das Promotionsbüro der Medizinischen Fakultät die Vorlage des Staatsexamenzeugnisses bestätigt.
