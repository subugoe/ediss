	...
	<xsl:template name="confirmation">
		<html>
			...
			<body>
				...
				<p class="clearfix">
				Es wird hiermit bestätigt, dass der Abstract der Dissertation des oben genannten Antragstellers von der Niedersächsischen Staats- und Universitätsbibliothek in elektronischer Form veröffentlicht wurde. Die Adresse der Veröffentlichung lautet:
				</p>
				<p class="uri"><xsl:value-of select="//dim:field[@element='identifier'][@qualifier='uri']"/></p>
				<p>Die vollständige Version der Dissertation wird nach Ablauf einer Frist von 6 Monaten (s. Prüfungsordnung GGNB §14, Abs. 6) online gestellt. Maßgeblich hierfür ist der Tag der Disputation. 
				</p>
				<p>
				Eine schriftliche Bestätigung des Antragstellers, dass die der SUB Göttingen übergebenen ausgedruckten Exemplare mit der elektronischen Fassung identisch sind, liegt vor. 
				</p>
