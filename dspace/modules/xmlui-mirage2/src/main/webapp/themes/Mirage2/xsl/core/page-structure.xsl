...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHead">
	    ...
	    <link rel="stylesheet" href="{concat($theme-path, 'styles/addon.css')}"/>
	    <link rel="stylesheet" href="{concat($theme-path, 'styles/fontello.css')}"/>
    ...
    <xsl:template name="buildHeader">
        ...
        <header>
            <div class="navbar navbar-default navbar-static-top" role="navigation">
				...
				<!-- <img src="{$theme-path}images/header.png" /> -->
                        </a>
						...
						<b class="visible-xs glyphicon glyphicon-user auth" aria-hidden="true">
							<!-- &#160;
						<b class="caret"/> -->
						</b>
                                        </button>
					   ...
					   <li>
						   <span id="authuser">
							<xsl:value-of select="substring(/dri:document/dri:meta/dri:userMeta/dri:metadata[@element='identifier' and @qualifier='firstName'], 1, 1)"/>
                                                        <xsl:text>. </xsl:text>
		    ...
		    <div class="navbar-header pull-right hidden-xs">
			    <ul class="nav navbar-nav pull-left">
			                <form id="searchbox" method="post" class="pull-right hidden-xs hidden-sm visible-md visible-lg">
                        ...
                        <fieldset>
                           <div class="input-group">
                                <input class="ds-text-field" type="text" placeholder="xmlui.general.search"
		...
		<form id="searchbox" method="post" class="pull-right visible-xs  visible-sm hidden-md hidden-lg">
                        <xsl:attribute name="action">
                            <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath']"/>
                            <xsl:value-of
                                    select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='search'][@qualifier='simpleURL']"/>
