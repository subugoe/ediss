...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:field[@type='composite'][dri:field/dri:instance | dri:params/@operations]" priority="3">
        ...
        <xsl:if test="contains(dri:params/@operations,'add')">
            ...
            <input type="submit" value="+" name="{concat('submit_',@n,'_add')}" class="ds-button-field ds-add-button">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
			    	...
			    	<!-- M.M. set default author to authenticated user -->
                                                        ...
                                                        <xsl:when test="./@id='aspect.submission.StepTransformer.field.dc_affiliation_email'">
